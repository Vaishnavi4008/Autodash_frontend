...
function Dashboard() {
  ...
  const promptMap = {
    "Compare the sales of the cities Pune, Mumbai, Chennai with a line graph": <DashboardCard08 />,
    "What is the average sales of Pune stores in 2024":<DashboardCard14 />,
    "Compare the revenue generated by Market Yard Store vs Viman Nagar Store": <DashboardCard06 />,
    "Display the popularity trends of products in different seasons": <DashboardCard06 />,
              ...
              <>
                ...
                <Backdrop
                  ...
                  onClick={(e) => {
                    ...
                    if (!e.target.className.startsWith("MuiBackdrop-root"))
                      return;
                ...
                >
                  <div className="flex flex-col items-center justify-center py-10 text-center">
                    ...
                    <p className="m-0 mt-10">
                      Enter the prompt and click on submit
                    </p>
                    <textarea
                      type="text"
